...
def prune_weights(pruning_cov, pruning_cov2, pruning_fc, pruning_fc2, weights, weight_mask, biases, biases_mask, recover_rates):
    ...
    file_name = 'weights_log/'+ 'pcov'+str(pruning_cov)+'pcov'+str(pruning_cov2)+'pfc'+str(int(round(pruning_fc*10)))+ 'pfc'+ str(pruning_fc2) + '.pkl'
            ...
            if (TRAIN == True):
                ...
                for epoch in range(training_epochs):
                    ...
                    for i in range(total_batch):
                        ...
                        if (accuracy_mean > 0.99 or epoch > 1000):
                            accuracy_list = np.zeros(30)
                            accuracy_mean = 0
                            print('Training ends')
                            ...
                            if (test_accuracy > 0.9936 or epoch > 1000):
